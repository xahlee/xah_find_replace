...
To use, open the script, and edit the input path, and other parameters. These script does not use command line args by design. This might change in the future.
